      ...
      <motion.div
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="relative mx-auto mt-10 w-full max-w-xl">
            ...
            {!files.length && (
              <div className="relative w-full flex items-center justify-center mt-4 h-32">
                <motion.div
                  ...
                  className={cn(
                    "relative z-40 flex h-32 w-full max-w-[8rem] items-center justify-center rounded-md bg-white group-hover/file:shadow-2xl dark:bg-neutral-900 border border-white/5",
                ...
                <motion.div
                  ...
                  className="absolute z-30 flex h-32 w-full max-w-[8rem] items-center justify-center rounded-md border border-dashed border-sky-400 bg-transparent opacity-0"
                />
              </div>
            )}
          </div>
